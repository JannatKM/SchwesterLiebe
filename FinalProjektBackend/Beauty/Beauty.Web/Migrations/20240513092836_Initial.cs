        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Name = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    IsDown = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookTime = table.Column<int>(type: "INTEGER", nullable: true),
                    IsVacation = table.Column<bool>(type: "INTEGER", nullable: false),
                    VacationDescription = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    EmployeeId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeCalendars", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeeCalendars_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Hair Care Service", 60, "Hair Care", 10m },
                    { 2, "Facial Service", 60, "Facial", 19m },
                    { 3, "Massages Service", 120, "Massages", 49m },
                    { 4, "Waxing Service", 180, "Waxing", 99m },
                    { 5, "Nail Service", 60, "Nail", 29m }
                });
            ...
            migrationBuilder.InsertData(
                table: "Rooms",
                columns: new[] { "Id", "Description", "IsDown", "Name" },
                values: new object[,]
                {
                    { 1, null, false, "Room 1" },
                    { 2, null, false, "Room 2" },
                    { 3, "Repairing", true, "Room 3" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "FirstName", "LastName", "Password", "RoleId", "Telephone" },
                values: new object[] { 1, "admin@gmail.com", "John", "Smith", "123456", 1, "12345678901" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeCalendars_EmployeeId",
                table: "EmployeeCalendars",
                column: "EmployeeId");
